(function() {
    var client = algoliasearch('DG1BGR164N', '8cedbc41beea07282daf9ca2f1b31aa6');
    var index = client.initIndex('productos_tienda');
    ...
    autocomplete('#aa-search-input',
        { hint: false }, {
            ...
            window.location.href = window.location.origin + '/productos/' + suggestion.slug;
            enterPressed = true;
